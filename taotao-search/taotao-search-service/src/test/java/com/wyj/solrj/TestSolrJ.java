...
public class TestSolrJ {
	...
	public void testQueryDocument() throws Exception {
	    HttpSolrServer solrServer = new HttpSolrServer("http://192.168.25.129:8080/solr/mycore");
	    // 创建一个SolrQuery对象
	    SolrQuery query = new SolrQuery();
	    query.setQuery("手机");
	    // 设置自己的分页条件
